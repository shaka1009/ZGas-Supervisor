  ...
  private void requestPermission() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA)) {
        Toast.makeText(
                zgas.supervisor.IA.CameraActivity.this,
 ...
 protected void setFragment() {
        ...
        if (useCamera2API) {
                    ...
                    CameraConnectionFragment.newInstance(
                            new CameraConnectionFragment.ConnectionCallback() {
                                ...
                                public void onPreviewSizeChosen(final Size size, final int rotation) {
                                    ...
                                    zgas.supervisor.IA.CameraActivity.this.onPreviewSizeChosen(size, rotation);
                                }
                            },
                            this,
                            getLayoutId(),
          ...
          int facing = (useFacing == CameraCharacteristics.LENS_FACING_BACK) ?
            ...
            zgas.supervisor.IA.LegacyCameraConnectionFragment frag = new zgas.supervisor.IA.LegacyCameraConnectionFragment(this,
                    getLayoutId(),
